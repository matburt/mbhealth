...
def get_health_data(db: Session, id: int) -> HealthData | None:
...
def create_health_data(db: Session, *, obj_in: HealthDataCreate, user_id: int, user_timezone: str | None = None) -> HealthData:
    db_obj = HealthData(
        user_id=user_id,
